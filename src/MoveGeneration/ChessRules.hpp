...
public:
    ...
    static constexpr std::array<uint64_t,2> QBlockers{ /* W */ (1ull<<2)|(1ull<<3), /* B */ (1ull<<58)|(1ull<<59) };
    static constexpr std::array<uint64_t,2> QBlockersRook{ /* W */ (1ull<<1)|(1ull<<2)|(1ull<<3), /* B */ (1ull<<57)|(1ull<<58)|(1ull<<59) };
